...
//==============================================================================
class SamplePreprocessingToolApplication  : public juce::JUCEApplication
{
public:
    //==============================================================================
    SamplePreprocessingToolApplication() {}
    ...
    */
    ...
    public:
                              ...
                              DocumentWindow::minimiseButton | DocumentWindow::closeButton)
        {
            ...
            auto look = dynamic_cast<juce::LookAndFeel_V4*>(&getLookAndFeel());
...
START_JUCE_APPLICATION (SamplePreprocessingToolApplication)
